...
const fr: Messages = {
	...
	language: {
		contribute: 'Contribuer à améliorer la qualité de la traduction',
	...
	chart: {
		...
		editions: {
			tab: 'Éditions',
			title: 'Participation par édition',
			splitDesc: 'Part des inscriptions',
			inPersonOnly: 'En présentiel',
			includeOnline: 'Inclure le distanciel',
			hostCountry: 'Pays hôte',
			international: 'International',
			cancelled: 'Annulée',
			shareLabel: 'Part',
			unknown: 'Non réparti',
			noBreakdown: 'Certaines éditions n’ont pas de données détaillées.',
			partialSplit: 'La répartition ne couvre qu’une partie du total',
			source: 'Source : données annuelles FOSS4G',
			table: {
				edition: 'Édition',
				registrations: 'Inscrits',
				inPerson: 'En présentiel',
				online: 'En ligne',
				hostShare: 'Part du pays hôte',
				status: 'Statut'
			}
		}
	},
	...
	region: {
		eastAsiaPacific: "Asie de l'Est et Pacifique",
		europeCentralAsia: 'Europe et Asie centrale',
		latinAmericaCaribbean: 'Amérique latine et Caraïbes',
		middleEastNorthAfrica: 'Moyen-Orient et Afrique du Nord',
